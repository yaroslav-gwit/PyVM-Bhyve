        ...
        if len(remote_zfs_snapshot_list) > 0:
            ...
            for snapshot_index, snapshot_value in enumerate(vm_zfs_snapshot_list):
                if snapshot_index != len(vm_zfs_snapshot_list)-1:
                    ...
                    print(" 🔷 DEBUG: Sending INCREMENTAL snapshot (snap: " + vm_zfs_snapshot_list[snapshot_index + 1] + ")" + str(snapshot_index + 1) + " out of " + str(len(vm_zfs_snapshot_list)-1) + " (size: " + str_shell_output + ")")
